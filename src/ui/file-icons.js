// Alias for file-icons
// Recovered module id: 175
"use strict";

const { IconPack } = require("./icon-core.js");
/**
 * Defines file icons
 */
exports.fileIcons = {
    defaultIcon: { name: 'file' },
    defaultBlockIcon: { name: 'block' },
    defaultSocketsIcon: { name: 'sockets' },
    defaultCharacterIcon: { name: 'character' },
    defaultPipeIcon: { name: 'pipe' },
    icons: [
        ...
        { name: 'typescript', fileExtensions: ['ts'], fileNames: [
                'tsconfig.json'
            ] },
        ...
        { name: 'perl', fileExtensions: ['pm', 'raku', 'pl', 'perl'] },
        ...
        { name: 'rpm', fileExtensions: ['rpm'] },
        { name: 'deb', fileExtensions: ['deb'] },
        { name: 'bak', fileExtensions: ['bak', 'old'] },
        { name: 'pid', fileExtensions: ['pid'] },
        { name: 'so', fileExtensions: ['so', 'so.1', 'so.2', 'so.3', 'so.4', 'so.5', 'so.6', 'so.7', 'so.8', 'so.9'] },
        { name: 'run', fileExtensions: ['bin', 'run'] },
    ],
};
