    ...
    createForwardView(sshInfo) {
        ViewManager.createWebviewPanel({
            ...
            eventHandler: (handler) => {
                const titles = {
                    connect_err_title: (0, Localize)("xplot.view.forward.connect.err.title"),
                    host_title: (0, Localize)("xplot.view.forward.host.title"),
                    name_title: (0, Localize)("xplot.view.forward.name.title"),
                    localhost_title: (0, Localize)("xplot.view.forward.localhost.title"),
                    localport_title: (0, Localize)("xplot.view.forward.localport.title"),
                    remotehost_title: (0, Localize)("xplot.view.forward.remotehost.title"),
                    remoteport_title: (0, Localize)("xplot.view.forward.remoteport.title"),
                    type_title: (0, Localize)("xplot.view.forward.type.title"),
                    operation_mode_title: (0, Localize)("xplot.view.forward.operation.mode.title"),
                    operation_mode_ssh2_forward_title: (0, Localize)("xplot.view.forward.operation.mode.ssh2.forward.title"),
                    operation_mode_local_ssh_exec_title: (0, Localize)("xplot.view.forward.operation.mode.local.ssh.exec.title"),
                    operation_mode_description: os.type() == "Windows_NT"
                        ? (0, Localize)("xplot.view.forward.operation.mode.description.windows.title")
                        : (0, Localize)("xplot.view.forward.operation.mode.description.linux.title"),
                    type_local_port_forward_title: (0, Localize)("xplot.view.forward.type.local.port.forward.title"),
                    type_remote_port_forward_title: (0, Localize)("xplot.view.forward.type.remote.port.forward.title"),
                    type_socks5proxy_title: (0, Localize)("xplot.view.forward.type.socks5proxy.title"),
                    state_title: (0, Localize)("xplot.view.forward.state.title"),
                    description_title: (0, Localize)("xplot.view.forward.description.title"),
                    ...
                    state_running_title: (0, Localize)("xplot.view.forward.state.running.title"),
                    state_stoped_title: (0, Localize)("xplot.view.forward.state.stoped.title"),
                };
                handler.on("init", () => {
                    ...
                    try {
                        ...
                        Console.info((0, Localize)("xplot.msg.forward.add.ok", ForwardVO.title(forward)));
                        handler.emit("show", { sshvo: loaded, titles: titles });
                    }
                    catch (err) {
                        Console.warn((0, Localize)("xplot.msg.forward.add.no", ForwardVO.title(forward), err.message));
                    ...
                    try {
                        ...
                        Console.info((0, Localize)("xplot.msg.forward.update.ok", ForwardVO.title(forward)));
                        handler.emit("show", { sshvo: this.load(sshInfo), titles: titles });
                    }
                    catch (err) {
                        Console.warn((0, Localize)("xplot.msg.forward.add.no", ForwardVO.title(forward), err.message));
                    ...
                    try {
                        ...
                        Console.info((0, Localize)("xplot.msg.forward.start.ok", ForwardVO.title(forward)));
                        handler.emit("show", { sshvo: this.load(sshInfo), titles: titles });
                        handler.emit("success");
                    }
                    catch (e) {
                        Console.warn((0, Localize)("xplot.msg.forward.start.no", ForwardVO.title(forward), e.message));
                    }
                    ...
                    try {
                        ...
                        Console.info((0, Localize)("xplot.msg.forward.stop.ok", ForwardVO.title(forward)));
                        handler.emit("show", { sshvo: this.load(sshInfo), titles: titles });
                        handler.emit("success");
                    }
                    catch (e) {
                        Console.warn((0, Localize)("xplot.msg.forward.stop.no", ForwardVO.title(forward), e.message));
                    }
                })).on("remove", content => {
                    const forward = content;
                    if (!forward.id) forward.id = require('crypto').randomUUID();
                    if (!forward.sshId) forward.sshId = sshInfo.id;
                    vscode.window.showQuickPick([(0, Localize)("xplot.yes"), (0, Localize)("xplot.no")], { placeHolder: (0, Localize)("xplot.msg.forward.remove.title", ForwardVO.title(forward)), canPickMany: false }).then((str) => __awaiter(this, void 0, void 0, function* () {
                        if (str == (0, Localize)("xplot.yes")) {
                            try {
                                ForwardVO.del(forward.id);
                                Console.info((0, Localize)("xplot.msg.forward.remove.ok", ForwardVO.title(forward)));
                                handler.emit("show", { sshvo: this.load(sshInfo), titles: titles });
                            }
                            catch (e) {
                                Console.warn((0, Localize)("xplot.msg.forward.remove.no", ForwardVO.title(forward), e.message));
                            }
                        }
                    }));
                }).on("load", () => {
