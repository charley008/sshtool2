...
class RemoteService {
    createRemoteView(sshInfo) {
        const tis = {
            title: (0, Localize)("sshtool.view.rdesktop.title"),
            name_title: (0, Localize)("sshtool.view.rdesktop.name.title"),
            active_title: (0, Localize)("sshtool.view.rdesktop.active.title"),
            fullscreen_title: (0, Localize)("sshtool.view.rdesktop.fullscreen.title"),
            mode_title: (0, Localize)("sshtool.view.rdesktop.mode.title"),
            port_title: (0, Localize)("sshtool.view.rdesktop.port.title"),
            colordepth_title: (0, Localize)("sshtool.view.rdesktop.colordepth.title"),
            desktopgeometry_title: (0, Localize)("sshtool.view.rdesktop.desktopgeometry.title"),
            status_title: (0, Localize)("sshtool.view.rdesktop.status.title"),
            ...
            status_running_title: (0, Localize)("sshtool.view.forward.state.running.title"),
            status_stoped_title: (0, Localize)("sshtool.view.forward.state.stoped.title"),
        };
        ViewManager.createWebviewPanel({
            ...
            eventHandler: (handler) => {
                handler.on("init", () => {
                    ...
                    try {
                        RemoteVO.put(remote);
                        Console.info((0, Localize)("sshtool.msg.forward.add.ok", RemoteVO.title(remote)));
                        handler.emit("show", { sshvo: this.load(sshInfo), titles: tis });
                    }
                    catch (err) {
                        Console.warn((0, Localize)("sshtool.msg.forward.add.no", RemoteVO.title(remote), err.message));
                    ...
                    try {
                        ...
                        Console.info((0, Localize)("sshtool.msg.forward.update.ok", RemoteVO.title(remote)));
                        handler.emit("show", { sshvo: this.load(sshInfo), titles: tis });
                    }
                    catch (err) {
                        Console.warn((0, Localize)("sshtool.msg.forward.add.no", RemoteVO.title(remote), err.message));
                    ...
                    if (!remote.id) remote.id = require('crypto').randomUUID();
                    if (!remote.eId) remote.eId = sshInfo.id;
                    vscode.window.showQuickPick([(0, Localize)("sshtool.yes"), (0, Localize)("sshtool.no")], { placeHolder: (0, Localize)("sshtool.msg.forward.remove.title", RemoteVO.title(remote)), canPickMany: false }).then((str) => __awaiter(this, void 0, void 0, function* () {
                        if (str == (0, Localize)("sshtool.yes")) {
                            try {
                                RemoteVO.del(remote.id);
                                Console.info((0, Localize)("sshtool.msg.forward.remove.ok", RemoteVO.title(remote)));
                                handler.emit("show", { sshvo: this.load(sshInfo), titles: tis });
                            }
                            catch (e) {
                                Console.warn((0, Localize)("sshtool.msg.forward.remove.no", RemoteVO.title(remote), e.message));
                            }
                        }
                    }));
                }).on("load", () => {
    ...
    start(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                Console.warn((0, Localize)("sshtool.msg.connect.rdesktop.start.err", RemoteVO.title(vo.remote), e.message));
                throw e;
            }
            vo.remote.status = true;
            Console.info((0, Localize)("sshtool.msg.connect.rdesktop.start.ok", RemoteVO.title(vo.remote)));
    ...
    stop(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                Console.warn((0, Localize)("sshtool.msg.connect.rdesktop.stop.err", RemoteVO.title(vo.remote), e.message));
                throw e;
            }
            vo.remote.status = false;
            Console.info((0, Localize)("sshtool.msg.connect.rdesktop.stop.ok", RemoteVO.title(vo.remote)));
            RemoteVO.post(vo.remote);
        });
    }
}
