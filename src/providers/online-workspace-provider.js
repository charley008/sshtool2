// Alias for online-workspace-provider
// Recovered module id: 235
"use strict";
...
class OnlineWorkspaceProvider extends WorkspaceProvider {
    getChildren(element) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!element) {
                ...
                if (constant_1.StatusBar.ALL == bar) {
                    const groupvos = GroupVO.getAll(constant_1.SSHType.ONLINE);
                    const nodes = Object.keys(groupvos).map((key) => {
                        const groupvo = groupvos[key];
                        if (groupvo.onlineSize > 0 && groupvo.workSpaceSize > 0) {
                    ...
                    return this.getWorkspaces(bar, constant_1.SSHType.ONLINE);
                }
            }
            else {
...
exports.default = OnlineWorkspaceProvider;
